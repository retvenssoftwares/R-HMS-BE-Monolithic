    ...
    try {
        ...
        const planData = {
           ...
           // phone:findProperty.phone[0].phone || '',
            phone: findProperty.phone && findProperty.phone.length > 0 ? findProperty.phone[0].phone : '',
           ...
           // reservationPhone:findProperty.reservationPhone[0].reservationPhone || '',
            reservationPhone: findProperty.reservationPhone && findProperty.reservationPhone.length > 0 ? findProperty.reservationPhone[0].reservationPhone : '',
            websiteUrl: findProperty.websiteUrl && findProperty.websiteUrl.length > 0 ? findProperty.websiteUrl[0].websiteUrl : '',
