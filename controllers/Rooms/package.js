...
export const packageRatePlan = async(req,res)=>{
    try{
        ...
        const {userId , propertyId, rateType, roomTypeId, ratePlanId,  shortCode , ratePlanInclusion ,ratePlanName, minimumNights, maximumNights, packageRateAdjustment, inclusionTotal ,ratePlanTotal , ipAddress, deviceType} = req.body
...
export const updatePackageRatePlan = async(req,res)=>{
    try{
        ...
        if(maximumNights){
            ...
            packageRatePlan.maximumNights.unshift(minimumNightsObject);
        }
        ...
        if(packageRateAdjustment){
            ...
            packageRatePlan.packageRateAdjustment.unshift(packageRateAdjustmentObject);
        }


        await packageRatePlan.save()

        return res.status(200).json({message : "packageRatePlan updated successfully" , statusCode : 200})
