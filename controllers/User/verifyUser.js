    ...
    try {
        ...
        if (propertyTypeSOC === "Single") {
            ...
            const property = new propertyModel({
                ...
                propertyType:[{ propertyType: singleProperty.propertyType }],
                websiteUrl: [{ websiteUrl: singleProperty.websiteUrl }],
                baseCurrency:  [{ baseCurrency: singleProperty.baseCurrency }],
                //propertyChainName : singleProperty.propertyChainName,
                propertyTypeName: singleProperty.propertyTypeName,
                starCategory: [{ starCategory: singleProperty.starCategory }],
                phoneNumber: singleProperty.phoneNumber,
                reservationNumber: [{ reservationNumber: singleProperty.reservationNumber }],
                registrationNumber:[{ registrationNumber: singleProperty.registrationNumber }],
                roomsInProperty: [{ roomsInProperty: singleProperty.roomsInProperty }],
                taxName:[{ taxName: singleProperty.taxName }],
                ratePercent: [{ ratePercent: singleProperty.ratePercent }],
                propertyRating: [{ propertyRating: singleProperty.propertyRating }],
